...
export default function LeadReports() {
    ...
    const [filteredStaffLeads, setFilteredStaffLeads] = useState(staffLeads);

    useEffect(() => {
        setFilteredStaffLeads(staffLeads);
    }, [staffLeads]);
            ...
            <Tabs defaultValue="general" className="w-full">
                ...
                <TabsContent value="general" className="space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <ResponsiveContainer width="100%" height={300}>
                                    <PieChart>
                                        <Pie
                                            ...
                                            dataKey="value"
                                        >
                                            {weeklyConversions?.map((entry, index) => (
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ResponsiveContainer width="100%" height={300}>
                                    <BarChart data={sourcesConversion}>
                ...
                <TabsContent value="staff" className="space-y-6">
                    <Card>
                        ...
                        <CardContent>
                            <ResponsiveContainer width="100%" height={400}>
                                <BarChart data={filteredStaffLeads}>
                                    <CartesianGrid strokeDasharray="3 3" />
                ...
                <TabsContent value="pipeline" className="space-y-6">
                    <Card>
                        ...
                        <CardContent>
                            <ResponsiveContainer width="100%" height={400}>
                                <BarChart data={pipelineLeads}>
                                    <CartesianGrid strokeDasharray="3 3" />
                                    <XAxis dataKey="name" />
                                    <YAxis />
                                    <Tooltip />
                                    <Bar dataKey="leads" fill="#ff7300" />
                                </BarChart>
                            </ResponsiveContainer>
                        </CardContent>
                    </Card>
