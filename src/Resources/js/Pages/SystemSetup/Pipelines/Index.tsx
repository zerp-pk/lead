...
export default function Index() {
    ...
    const { pipelines, auth } = usePage<PipelinesIndexProps>().props;
                        ...
                        {auth.user?.permissions?.includes('edit-pipelines') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => openModal('edit', pipeline)} className="h-8 w-8 p-0 text-blue-600 hover:text-blue-700">
                                        ...
                                        <DataTable
                                            ...
                                            emptyState={
                                                <NoRecordsFound
                                                    ...
                                                    description={t('Get started by creating your first Pipeline.')}
                                                    createPermission="create-pipelines"
                                                    onCreateClick={() => openModal('add')}
                                                    createButtonText={t('Create Pipeline')}
                                                    className="h-auto"
                                                />
                                            }
                                        />
