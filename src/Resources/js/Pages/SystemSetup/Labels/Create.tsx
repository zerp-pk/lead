...
import { CreateLabelProps, LabelFormData } from './types';

export default function Create({ onSuccess, pipelines, defaultPipelineId }: CreateLabelProps) {
    const { t } = useTranslation();
    const { data, setData, post, processing, errors } = useForm<LabelFormData>({
        name: '',
        color: '#FF6B6B',
